...
type Car struct {
	...
	IsElectric bool
	IsHybrid   bool
	Vehicle    Vehicle // This is like inheritance in OOP, but it's actually "composition" in Go
}
...
func (c Car) showDetails() {
	...
	c.Vehicle.showDetails() // This is like inheritance in OOP, but it's actually "composition" in Go
}
